  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[88vh] flex flex-col overflow-hidden border border-stone-200 animate-modal-in">
        ...
        {/* Form */}
        <form id="contact-form" onSubmit={handleSubmit} className="px-4 sm:px-6 py-5 space-y-5 overflow-y-auto">
          {/* Name */}
          <div>
        ...
        {/* Footer */}
        <div className="flex items-center justify-end gap-3 px-4 sm:px-6 py-4 border-t border-stone-100 bg-stone-50/50 flex-shrink-0">
